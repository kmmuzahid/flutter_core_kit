...
class CkGridView extends StatefulWidget {
  const CkGridView({
...
class _CkGridViewState extends State<CkGridView> {
  final GlobalKey _appBarKey = GlobalKey();
  final GlobalKey _stickyKey = GlobalKey();
  late final ScrollController _scrollController;
  late final CkGridConfig gridConfig;
  int? _dragStartIndex;
  ...
  void initState() {
    super.initState();
    gridConfig = widget.gridConfig ?? CkGridConfig();
  ...
  CkGridChildInfo calculateGridChildInfo({
    required int index,
