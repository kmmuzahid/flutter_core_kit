...
class CkMultiImagePickerFormField extends StatefulWidget {
  ...
  const CkMultiImagePickerFormField({
    super.key,
    this.isMulti = true,
  ...
  @override
  State<CkMultiImagePickerFormField> createState() =>
      _CkMultiImagePickerField();
}
...
class _CkMultiImagePickerField
  ...
  @override
  void didUpdateWidget(CkMultiImagePickerFormField oldWidget) {
