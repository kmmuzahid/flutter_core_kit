...
extension CkScreenUtilExtension on num {
  /// Scaled width based on design size
  double get w => CkScreenUtils.width(value: this);

  /// Scaled height based on design size
  double get h => CkScreenUtils.height(value: this);

  /// Scaled radius based on design size
  double get r => CkScreenUtils.radius(value: this);

  /// Scaled font size based on design size
  double get sp => CkScreenUtils.sp(value: this);
}

extension AspectRatioExtension on Size {
  double get arValue {
    final designW = CkScreenUtils._designWidth;
    final designH = CkScreenUtils._designHeight;
    final device = CkScreenUtils._deviceSize;
