      ...
      builder: (_) => AlertDialog(
          ...
          children: [
            RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    text: '❌ ${_getPermissionName(permission)} permission is permanently denied.\n\n',
                    style: TextStyle(fontFamily: fontFamily, color: errorColor, fontWeight: FontWeight.w600),
                  ),
                  TextSpan(
                  ...
                  TextSpan(
                    text: 'App Settings',
                    style: TextStyle(fontFamily: fontFamily, color: actionColor, decoration: TextDecoration.underline, fontWeight: FontWeight.bold),
                  ),
                  TextSpan(
        ...
        actions: [
          TextButton.icon(
            ...
            label: Text('Open Settings', style: TextStyle(fontFamily: fontFamily, color: actionColor, fontWeight: FontWeight.w600)),
          ),
          TextButton(
            onPressed: coreKitInstance.appbarConfig.getBack,
            child: Text('Cancel', style: TextStyle(fontFamily: fontFamily, color: Colors.grey[700])),
          ),
        ],
      ),
    );
