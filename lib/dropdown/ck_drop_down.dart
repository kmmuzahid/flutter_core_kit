...
class CkDropDownNameBuilderProperty<T> {
  ...
  CkDropDownNameBuilderProperty({required this.item, required this.isSelected});

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is CkDropDownNameBuilderProperty &&
        other.item == item &&
...
enum CkDropDownType { normal, menu }

class CkDropDown<T> extends StatefulWidget {
  const CkDropDown({
    required this.hint,
    required this.items,
  ...
  final Widget Function(CkDropDownNameBuilderProperty<T> property) nameBuilder;
...
class _CkDropDownState<T> extends State<CkDropDown<T>>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.dropDownType == CkDropDownType.menu) {
