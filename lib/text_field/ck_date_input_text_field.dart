...
class CkDateInputTextField extends StatefulWidget {
  ...
  @override
  State<CkDateInputTextField> createState() => _CkDateInputTextFieldState();
}

class _CkDateInputTextFieldState extends State<CkDateInputTextField> {
  ...
  Widget build(BuildContext context) {
    return CkTextField(
      ...
      onChanged: (value) {
        widget.onChanged?.call(CkUtils.parseDate(value));
      },

      hintText: widget.hints ?? 'YYYY-MM-DD',
      onSaved: (value, _) {
        if (widget.onSave == null) return;
        widget.onSave!(CkUtils.parseDate(value));
      },
      ...
      validationType: widget.isValidationRequired ?? false
          ? CkValidationType.validateDate
          : CkValidationType.notRequired,
