...
class CkMultilineTextField extends StatefulWidget {
  ...
  final String Function(TextEditingController controller)? onInitalize;
  ...
  final CkMultilineHintLimitBuilder? multilineLimitHintBuilder;
          ...
          child: () {
            final textFormField = TextFormField(
              ...
              style: _getStyle(
                ...
                fontSize: widget.fontSize ?? coreKitInstance.inputConfig.fontSize,
              ),
              ...
              final decoration = BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(
                    (widget.borderRadius != 12
                        ? widget.borderRadius
                        : (coreKitInstance.inputConfig.borderRadius ?? widget.borderRadius)).r,
                  ),
                border: Border.all(
...
class CkMultilineHintLimitBuilder {
